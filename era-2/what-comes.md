...
The Creation Era opened three games in 500 Epochs. Era II has 700 of its own — and a sovereign who has already shown how he announces things: *after* they are true.

{% hint style="success" %}
Fortunes are being accumulated both in plain sight and in the shadows. The board is live. [Enter](../realm/how-to-enter.md).
{% endhint %}
