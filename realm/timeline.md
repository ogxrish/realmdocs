...
## The Creation Era — UEC 1–699 (Sealed)

### Pre-OG

<details>

<summary><strong>Realm is founded.</strong><br>Mad OG harnesses the energy of the real world to open a portal into a place of infinite blockspace that we now know as the Realm of OGs.</summary>
...
<summary><strong>Tokens are minted — UEC 1.</strong><br>In order to facilitate the mechanics of all activity to be had within the Realm, Mad OG divided the entire value of the Realm into 6 tokens.</summary>
...
<summary><strong>OG Bank is established — UEC 2.</strong><br>The first of the Realm's Institutions to be established, OG Bank is tasked with the duty of protecting the Realm's value by safeguarding nearly all of the Realm tokens.</summary>
...
* 07/06/24 - OG Bank wallet receives Realm tokens
  * OG Realm transfers 10% $OGR to OG Bank - ([Solscan](https://solscan.io/tx/d6EbhacWqvuVJrNjM4A7qdX2SZpuvY3KHpNKGG5oQo8tK2ZkiBMELT2L8pFtoDVtifNYe8ZLJX3LKVLbnSkwt4h))
...
<summary><strong>OG Lab is established — UEC 2.</strong><br>A relatively unknown and mysterious new Institution appears as OG Bank transfers the Realm's OG Alchemy ($OGA) token to OG Lab.</summary>
...
* 07/06/24 - OG Bank transfers 70% $OGA to OG Lab — the first of two stages (80% total) - ([Solscan](https://solscan.io/tx/2dSNQkLGfqroubWXJwH32CUwsQ7Yav1ejF6F2u8YaMvHnebDfYFGVZL9ySLnKfPWE8ATMjUcoVjYRuJSjNLadp3c))

</details>

<details>

<summary><strong>Realm Pools are created — UEC 3.</strong><br>OG Bank integrates a framework for the entire token-physics of the Realm by bonding the 6 tokens to each other permanently, unifying the tokens and establishing the hierarchy.</summary>
...
<summary><strong>Eternal Pools are created.</strong><br>OG Bank connects the Realm's ecosystem to the real world by bonding 3 of the Realm tokens to outer-world assets, forging links and pathways to traditional value.</summary>
...
<summary><strong>OG Mine is established — Mine Epoch 1 = UEC 26.</strong><br>The first of its kind, OG Mine is given the sole duty of fairly distributing the scarce reserves of the Realm, OG Gold ($OGG), and begins emissions.</summary>
...
* 07/31/24 - $OGG emissions begin
* 11/28/24 - [Repurchase Program](../games/repurchase-programs.md) is launched

</details>

<details>

<summary><strong>OG Reserve is established — Reserve Epoch 1 = UEC 139.</strong><br>Built to empower OGs within the Realm to secure and safeguard their hard-earned $OGG within OG Reserve, yielding them OG Coin ($OGC) for their stake.</summary>
...
* 11/19/24 - $OGG locking begins
* 11/20/24 - $OGC emissions begin (00:00 UTC boundary — Reserve Epoch 1 = UEC 139)
* 09/30/25 - [Repurchase Program](../games/repurchase-programs.md) is launched

</details>

<details>

<summary><strong>Sanctioned Pools are created.</strong><br>OG Lab optimizes the Realm tokens' flow inside and outside of the Realm's ecosystem by establishing native liquidity for all remaining pools.</summary>
...
<summary><strong>OG Lab purchases $OGG.</strong><br>Continuing to showcase its diverse capabilities within the Realm's balance of power, OG Lab acquires a significant portion of the OG Gold ($OGG) supply.</summary>
...
<summary><strong>Realm Docs are published — UEC 170.</strong><br>Casting the Realm in light and clarity, detailed Docs for the Realm arrived, democratizing information, wisdom, and choice for all OGs within.</summary>

* 12/21/24 - [Docs](../the-gates.md) are published
...
<summary><strong>Discord community expands.</strong><br>Further democratizing the Realm's access to new OGs as the Pre-OG Era waned, the walls of the Realm's Discord were opened for all.</summary>
...
<summary><strong>Fees in $OGC introduced.</strong><br>Marking a significant moment in the Realm's development, OG Coin ($OGC) becomes the official unit of exchange, powering all of the Realm's exchange.</summary>

* 02/03/25 - $OGC for fees enabled

</details>

<details>

<summary><strong>Artificial Intelligence is integrated.</strong><br>Complexities of the Realm's information and balance spur an effort to help simplify the tools and guidance available to OGs old and new.</summary>

* 05/23/25 - [Knowledge Base](../canon/knowledge-base.md) launched
...
<summary><strong>Live token price integration.</strong><br>Emerging as a new critical data point with the Realm for all players and entities, live market data around the Realm's tokens is integrated.</summary>
...
<summary><strong>OG Lottery is established — and reborn. Lottery Epoch 1 = UEC 500.</strong><br>The Realm's high-stakes Institution arrives to test the primal urges of OGs, as OG Lottery begins releasing and burning OG Fool ($OGF). After a first age of operation, the Lottery is rebooted with bug fixes onto its own sovereign program — the canonical Lottery that runs today.</summary>
...
* 09/10/25 - $OGF emissions begin (the First Age)
* 10/01/25 - [Repurchase Program](../games/repurchase-programs.md) is launched
* 11/16/25 - OG Lottery program reborn onchain — **Lottery Epoch 1 = UEC 500**
* 11/17/25 - OG Lottery is rebooted with bug fixes; the first bid of the new age is cast

</details>

<details>

<summary><strong>The Classes are announced — UEC 501.</strong><br>As the player base grows and fortunes accumulate, OGs begin to emerge into new Classes — unlocking an entirely new level of the game.</summary>

* 11/17/25 - The [Class system](../society/classes.md) is published — OG, Degen, Builder, Capital, Knight, Noble; Guardian and King sealed
* In the months that follow, the first Knights assemble their bonds and the court of the Realm takes form
...
<summary><strong>The Alchemy Airdrop is seeded — the OG Airdrop wallet is funded.</strong><br>In the closing epochs of the Creation Era, OG Lab transfers half of the OG Alchemy ($OGA) supply to the OG Airdrop wallet, and OG Bank tops the Lab back to its 30% institutional floor — completing the 80/50/30 $OGA structure ahead of the Alchemy Airdrop at UEC 904.</summary>

* 05/05/26 - OG Lab transfers 50% $OGA (500,000) to the OG Airdrop wallet - ([Solscan](https://solscan.io/tx/JtKZVBrpps8hjj9BEXWNDjG8aQBKCTvPiFfaEuPAhvdN8uRVEL44AJvZhfzYhnAfXKzKSXVxDN7aMuNZRHF75WT))
* 05/07/26 - OG Bank transfers a further 10% $OGA (100,000) to OG Lab — restoring the Lab to its 30% floor (80% endowed − 50% to the Airdrop) - ([Solscan](https://solscan.io/tx/5pjJu8QtzZJ54G7nbLJqSSPQWiX8tDqvapjgvkNkcVN88K8uyuQs2P9pbh3SKBv9CUgrAFyVq5qE7Y45R8JrzPoe))

</details>

<details>

<summary><strong>The Universal Epoch Clock is revealed — UEC 700. The Creation Era is sealed.</strong><br>The Mad OG names what had been running since the first block: the Realm's single sovereign calendar. Era I — the Creation Era, UEC 1–699 — is sealed, and the unnamed second era begins.</summary>

* 06/04/26 - The [Universal Epoch Clock](../physics/epochs.md) is activated — UEC Epoch 700
* 06/04/26 - Era I, the **Creation Era** (UEC 1–699), is sealed by sovereign decree
* Era II begins, deliberately unnamed — *"Epoch 700 begins the next."*
